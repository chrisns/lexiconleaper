...
<template>
  ...
  <div id="buttons">
    ...
    <button @click="showInstructions = !showInstructions" :class="{ on: showInstructions }">How to play</button>
  </div>
  ...
  <div id="instructions" v-if="showInstructions">
    ...
    <p>You or someone in your group must name something that matches the category that begins with the letter before the time runs out</p>
    ...
    <p>If you want to mix things up you can select to have a <a @click="randomGame = !randomGame">random category</a> and/or <a @click="randomLetter = !randomLetter">random letter</a> on each play</p>
